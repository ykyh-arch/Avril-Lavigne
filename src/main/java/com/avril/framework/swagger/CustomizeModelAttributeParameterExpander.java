package com.avril.framework.swagger;
...
import com.avril.framework.swagger.annotation.IgnoreSwaggerParameter;
        ...
        try {
            ...
            for (PropertyDescriptor descriptor : descriptors) {
                ...
                try {
                    ...
                    field = ReflectUtils.getAccessibleField(clazz, descriptor.getName());
                } catch (Exception e) {
